...
>>>>>>> cb509e869fdc6a620dca8bdf076700d9ae21aae5
        ...
        <div class="main-content">
            ...
            <header class="main-header">
                <h1 class="h4"><a href="<?= base_url('/'); ?>">Home</a> / Dashboard Admin</h1>
            </header>
                ...
                <div class="row justify-content-left">
                    <div class="col-md-3">
                        <div class="card custom-card style=" background-color: #0062cc ">
                            <div class=" card-header"><a href="<?= base_url('akun'); ?>">Kelola Akun</a></div>
                    </div>
                </div>

                <div class="col-md-3">
                    <div class="card custom-card">
                        <div class="card-header"><a href="<?= base_url('rps'); ?>">Kelola RPS</div>
                    </div>
                </div>
            </div>
        </div>
