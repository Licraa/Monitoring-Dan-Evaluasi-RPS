    ...
    <div class="dashboard-container">
        ...
        <div class="main-content">
            ...
            <header class="main-header">
                <h1 class="h4"><a href="<?= base_url('/'); ?>">Home</a> / Kelola Akun</h1>
            </header>
            ...
            <button class="btn-add"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-circle-fill" viewBox="0 0 16 16">
                ...
                </svg><a href="<?= base_url('tambah'); ?>">Tambah User</a></button>
                    ...
                    <?php foreach ($users as $key => $value): ?>
                        <tr>
                            ...
                            <td><span class="status-edit" title="Edit">
                                ...
                                <form action="<?= base_url('deleteuser/' . $value->id) ?>" method="post" style="display:inline;" onsubmit="return confirmDelete();">
